                        ...
                        <form method="POST" action="proses_tambah.php" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="judul" placeholder="Judul artikel"
                                    autocomplete="off" required="required" name="judul">
                            </div>
                            <div class="form-group">
                                <label for="id_kategori">Kategori Event</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" id="foto" placeholder="foto artikel"
                                    autocomplete="off" required="required" name="foto">
                            </div>
                            <div class="form-group">
